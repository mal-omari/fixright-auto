...
export default function WhyFixRight() {
  ...
  return (
    <section
      ref={sectionRef}
      style={{ background: 'var(--color-bg-primary)', borderTop: '1px solid var(--color-bg-surface)' }}
          ...
          {features.map((feat, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Icon size={24} color="var(--color-accent-amber)" strokeWidth={1.5} />
                </div>
                <h3 className="mb-3 text-lg font-bold tracking-wide" style={{ color: 'var(--color-text-primary)' }}>
                  {feat.title}
                </h3>
