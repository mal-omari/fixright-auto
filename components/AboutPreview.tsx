  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl text-center">
        <span className="about-preview-item mb-3 block text-xs tracking-[0.3em] uppercase" style={{ color: 'var(--color-accent-amber)', fontFamily: 'monospace' }}>
          Our Story
        </span>
        <h2 className="about-preview-item mb-6 text-4xl font-bold leading-tight" style={{ color: 'var(--color-text-primary)' }}>
          MEET YOUR MECHANIC
        </h2>
